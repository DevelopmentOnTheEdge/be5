...
public class Parser implements ParserConstants {
  ...
  final public SelectorRule parse() throws ParseException {UnionSelectorRule rule;
...
{if ("" != null) return rule;}
  ...
  final public UnionSelectorRule getUnionSelector() throws ParseException {List rules = new ArrayList();
...
rules.add(rule);
  ...
  final public HierarchySelectorRule getHierarchySelector() throws ParseException {List rules = new ArrayList();
...
rules.add(rule);
  ...
  final public ComplexSelectorRule getComplexSelector() throws ParseException {List rules = new ArrayList();
    SelectorRule rule;
...
rules.add(rule);
  ...
  final public SelectorRule getSimpleSelector() throws ParseException {SelectorRule rule;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENT:{
...
{if ("" != null) return rule;}
  ...
  final public SelectorRule getClassSelector() throws ParseException {Token t;
    t = jj_consume_token(IDENT);
{if ("" != null) return new ElementClassRule(t.image);}
    throw new Error("Missing return statement in function");
  }

  final public SelectorRule getNameSelector() throws ParseException {Token t;
...
{if ("" != null) return new AttributeRule("name", t.image);}
  ...
  final public SelectorRule getTypeSelector() throws ParseException {Token t;
...
{if ("" != null) return new AttributeRule("type", t.image);}
  ...
  final public SelectorRule getAttributeSelector() throws ParseException {Token op, name, value;
...
{if ("" != null) return new AttributeRule(name.image, value.image, op.image);}
  ...
  final public SelectorRule getNotSelector() throws ParseException {SelectorRule rule;
...
{if ("" != null) return new NotRule(rule);}
  ...
  final public SelectorRule getMatchesSelector() throws ParseException {SelectorRule rule;
