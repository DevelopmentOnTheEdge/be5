...
public class Fields
{
    ...
    private static final List<Field> FILE_STRUCTURE = Collections.unmodifiableList(Arrays.asList(
            ...
            new Field("groovyQueriesDir", "src/groovy/queries"),
            new Field("groovyOperationsDir", "src/groovy/operations"),
            new Field("groovyExtendersDir", "src/groovy/extenders"),
    ...
    private static final List<Field> CONNECTION_PROFILE = Collections.unmodifiableList(Arrays.asList(
