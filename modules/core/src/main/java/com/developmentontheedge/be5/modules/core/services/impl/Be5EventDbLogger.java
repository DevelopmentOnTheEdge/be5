...
//    }
//
//    protected String storeRecord(String login, String remoteAddr, String start, String action, String entity, String title
//       ) throws SQLException
//    {
//        if( login == null )
//        {
...
//        }
//
//        String sql = connector.getAnalyzer().makeInsertIntoWithAutoIncrement(
//            eventLogTableName, "ID" );
//
//        sql += " login, ip, " + connector.getAnalyzer().quoteIdentifier( "START" ) +
//               ", action, entity, title ) ";
//
//        sql += connector.getAnalyzer().makeInsertValuesWithAutoIncrement();
//
//        sql += Utils.safestr( connector, login, true ) + ","
//            + remoteAddr + "," + start + ","
//            + Utils.safestr( connector, action, true ) + ","
//            + Utils.safestr( connector, entity, true ) + ","
//            + Utils.safestr( connector, title, true )
//            + ")";
//
