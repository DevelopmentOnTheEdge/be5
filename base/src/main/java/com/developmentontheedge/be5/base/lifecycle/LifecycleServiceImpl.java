...
package com.developmentontheedge.be5.base.lifecycle;
...
public class LifecycleServiceImpl implements LifecycleService
{
    ...
    public void start()
    {
        ...
        log.info("Starting Be5 application...");
        ...
        log.info("Be5 application started in {}ms", time);
    ...
    public void stop()
    {
        ...
        log.info("Stopping Be5 application...");
        state = State.STOPPING;
        lifecycleRegister.stop();
        long time = System.currentTimeMillis() - start;
        log.info("Be5 application stopped in {}ms", time);
        state = lifecycleRegister.isStarted() ? State.STARTED : State.STOPPED;
    }
