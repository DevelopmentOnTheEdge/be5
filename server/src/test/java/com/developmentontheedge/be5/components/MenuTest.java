...
public class MenuTest extends AbstractProjectTest
{
    ...
    public static void init(){
        component = loadedClasses.get("menu");
    }
    ...
    public void test()
    {
        ...
        component.generate(getRequestWithUri(""), response, sp);
    ...
    public void testWithIds()
    {
        ...
        component.generate(getRequestWithUri("withIds"), response, sp);
    ...
    public void testDefaultAction()
    {
        ...
        component.generate(getRequestWithUri("defaultAction"), response, sp);
    ...
    public void testUnknownAction()
    {
        ...
        component.generate(getRequestWithUri("foo"), response, sp);
