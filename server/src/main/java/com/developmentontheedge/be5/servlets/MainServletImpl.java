...
public class MainServletImpl
{
    ...
    private final DaemonStarter starter;
    ...
    public void init(Object config)
    {
        ...
        Utils.setDefaultConnector( Be5.getDatabaseConnector() );
        try
        {
    ...
    public void respond(Object requestObj, Object responseObj, String method, String requestUri, Map<String, String[]> parameters)
    {
        ...
        try
        {
            preprocessRequest( request, serviceProvider.getDatabaseConnector(), UserInfoManager.get(req, serviceProvider).getUserInfo(), "qps" );
        }
    ...
    void preprocessRequest(HttpServletRequest request, DatabaseConnector connector, UserInfo userInfo, String url)
            throws NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException
    {
        ...
        if( className != null )
        {
            RequestPreprocessor preprocessor = Classes.tryLoad( className, RequestPreprocessor.class )
                    .getConstructor( DatabaseConnector.class, UserInfo.class ).newInstance( connector, userInfo );
