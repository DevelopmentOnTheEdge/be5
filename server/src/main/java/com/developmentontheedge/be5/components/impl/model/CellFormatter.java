...
public class CellFormatter
{
    ...
    CellFormatter(Query query, QueryExecutor queryExecutor, Injector injector)
    {
        this.query = query;
    ...
    private List<String> toRow(DynamicPropertySet dps, VarResolver varResolver)
    {
        ...
        return StreamEx.of(dps.spliterator()).map(property -> {
            ...
            String processedCell = format(new TableModel.RawCellModel((String) value), new CompositeVarResolver(new RootVarResolver(previousCells), varResolver));
